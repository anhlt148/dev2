...
<div class="col-xs-12" style="margin-top:15px;">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" method="POST" role="form" action="<?php echo base_url().'admin_category/admin_category_insert' ?>">
		<!-- tài khoản -->
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="cate_name" placeholder="Nhập tên danh mục" name="cate_name" class="col-xs-10 col-sm-8" />
