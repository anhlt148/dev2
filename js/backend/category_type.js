function saveItem(el) {
    ...
    call_ajax("POST", url, data, function (data, textStatus, jqXHR) {
        if (data != null && data.message == "") {
            ...
            html += '<button type="button" class="btn btn-warning" title="Sửa" onclick="confirm_edit(this);" style="padding:1px 6px; margin: 0 4px;" href="' + $("#base_url").val() + 'admin_category_type/edit/' + rs.type_id + '"><i class="fa fa-pencil-square-o"></i></button>'
